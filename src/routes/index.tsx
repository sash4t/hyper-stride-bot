      ...
      <main className="mx-auto max-w-7xl px-6 py-24">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex gap-3">
            <Link to="/auth" className="rounded-md bg-primary px-6 py-2.5 text-sm font-medium text-primary-foreground hover:opacity-90">Open terminal</Link>
            <a href="#features" className="rounded-md border border-panel-border px-6 py-2.5 text-sm font-medium hover:bg-panel">How it works</a>
          </div>
        </div>

        <div id="features" className="mt-24 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          {[
        ...
        <div className="panel mt-12 p-6 text-sm text-muted-foreground">
